...
import ng.codehaven.bambam.interfaces.MusicFocusable;
    ...
    private static void initializeStaticCompat() {
        try {
            ...
            sMethodRequestAudioFocus = AudioManager.class.getMethod(
                    "requestAudioFocus",
                    sClassOnAudioFocusChangeListener, int.class, int.class);
            sMethodAbandonAudioFocus = AudioManager.class.getMethod(
                    "abandonAudioFocus",
                    sClassOnAudioFocusChangeListener);
        ...
        } catch (ClassNotFoundException | IllegalAccessException | SecurityException | IllegalArgumentException | NoSuchFieldException | NoSuchMethodException e) {
